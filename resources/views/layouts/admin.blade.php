            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{URL("admin/category")}}"><i class="fa fa-circle-o"></i> News Category</a></li>
                        <li class="active"><a href="{{URL("admin/post")}}"><i class="fa fa-circle-o"></i> Create new post</a></li>
