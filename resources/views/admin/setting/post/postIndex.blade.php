                        ...
                        <table class="table table-hover">
                            ...
                            if($listData){
                                ...
                                foreach ($listData as $list){
                                    ...
                                    echo '<td class="col-md-2">'.$list['content'].'</td>';
                                    echo '<td><img width="100" height="100" src="'.$list['image'].'"></td>';
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="input" name ="title" value = "<?php echo $update_data!=null?$update_data["title"]:""; ?>"
                               class="form-control" id="exampleInputEmail1" placeholder="News title" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Content</label>
                        <textarea type="input" name ="content"
                                  rows="10"
                               class="form-control" id="exampleInputEmail1" placeholder="News title" >
                            <?php echo $update_data!=null?$update_data["content"]:""; ?>
                        </textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Fan Page Logo</label>
                        <input type="file" name ="image" class="form-control" id="exampleInputEmail1" placeholder="Post Image" >
                    </div>
